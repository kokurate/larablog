        ...
        <div class="col-12 mb-4">
          <article class="card article-card">
            ...
            <div class="card-body px-0 pb-1">
              ...
              <h2 class="h1">
                <a class="post-title" href="article.html">Is it Ethical to Travel Now? With that Freedom Comes Responsibility.</a>
              </h2>
              <p class="card-text">Heading Here is example of headings. You can use this heading by following markdownify rules. For example: use # for heading 1 and use ###### for heading 6.</p>
              <div class="content">
        ...
        <div class="col-md-6 mb-4">
          <article class="card article-card article-card-sm h-100">
            ...
            <div class="card-body px-0 pb-0">
              ...
              <h2>
                <a class="post-title" href="article.html">An Experiential Guide to Explore This Kingdom</a>
              </h2>
        ...
        <div class="col-md-6 mb-4">
          <article class="card article-card article-card-sm h-100">
            <a href="article.html">
              <div class="card-image">
                <div class="post-info">
                  <span class="text-uppercase">02 Jun 2021</span>
                  <span class="text-uppercase">2 minutes read</span>
                </div>
            ...
            <div class="card-body px-0 pb-0">
              ...
              <h2>
                <a class="post-title" href="article.html">What to Do in Houston: Ideas for Your Visit</a>
              </h2>
              <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna …</p>
              <div class="content">
                <a class="read-more-btn" href="article.html">Read Full Article</a>
        ...
        <div class="col-md-6 mb-4">
          <article class="card article-card article-card-sm h-100">
            <a href="article.html">
              <div class="card-image">
                <div class="post-info">
                  <span class="text-uppercase">01 Jun 2021</span>
                  <span class="text-uppercase">3 minutes read</span>
                </div>
            ...
            <div class="card-body px-0 pb-0">
              ...
              <h2>
                <a class="post-title" href="article.html">Alaska Cruises Will Restart as Biden Signs New Tourism Law</a>
              </h2>
              <p class="card-text">Heading Here is example of headings. You can use this heading by following markdownify rules. For example: use # for …</p>
              <div class="content">
                <a class="read-more-btn" href="article.html">Read Full Article</a>
              </div>
            </div>
        ...
        <div class="col-md-6 mb-4">
          <article class="card article-card article-card-sm h-100">
            <a href="article.html">
              <div class="card-image">
                <div class="post-info">
                  <span class="text-uppercase">30 May 2021</span>
                  <span class="text-uppercase">3 minutes read</span>
                </div>
            ...
            <div class="card-body px-0 pb-0">
              ...
              <h2>
                <a class="post-title" href="article.html">U.S. Travel Association Calls on CDC to Remove Cruise Restrictions</a>
              </h2>
              <p class="card-text">Heading Here is example of headings. You can use this heading by following markdownify rules. For example: use # for …</p>
              <div class="content">
                <a class="read-more-btn" href="article.html">Read Full Article</a>
        ...
        <div class="col-md-6 mb-4">
          <article class="card article-card article-card-sm h-100">
            <a href="article.html">
              <div class="card-image">
                <div class="post-info">
                  <span class="text-uppercase">29 May 2021</span>
                  <span class="text-uppercase">3 minutes read</span>
                </div>
            ...
            <div class="card-body px-0 pb-0">
              ...
              <h2>
                <a class="post-title" href="article.html">Top 7 Reasons to Visit Denver This Summer</a>
              </h2>
              <p class="card-text">Heading Here is example of headings. You can use this heading by following markdownify rules. For example: use # for …</p>
              <div class="content">
                <a class="read-more-btn" href="article.html">Read Full Article</a>
        ...
        <div class="col-md-6 mb-4">
          <article class="card article-card article-card-sm h-100">
            <a href="article.html">
              <div class="card-image">
                <div class="post-info">
                  <span class="text-uppercase">28 May 2021</span>
                  <span class="text-uppercase">2 minutes read</span>
                </div>
